...
class SecondNotificationService : Service() {
    ...
    private lateinit var secondNotificationBuilder: NotificationCompat.Builder

    // create a system handler which controls what thread the process is being executed on
    private lateinit var secondServiceHandler: Handler
    ...
    override fun onCreate() {
        ...
        secondNotificationBuilder = startForegroundService()
        ...
        val handlerThread = HandlerThread("SecondThread")
            .apply { start() }
        secondServiceHandler = Handler(handlerThread.looper)
    }
